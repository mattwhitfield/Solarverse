...
namespace Solarverse.Core.Control
{
    ...
    {
        public static Period TariffUpdates { get; } = new Period(TimeSpan.FromDays(1), TimeSpan.FromHours(17));
        ...
        public static Period ConsumptionUpdates { get; } = new Period(TimeSpan.FromDays(1));
    }
}
